...
| `footColliderRadius` | `float` | `FootMovement` | Foot circle collider radius in world units | Added to raycast hit Y so feet land on top of surfaces, not inside them | All step target Y positions |
